...
# 添加元数据标签
LABEL org.opencontainers.image.title="agent-kefu-learning"
LABEL org.opencontainers.image.description="Public learning edition of an AI customer-service automation project"
